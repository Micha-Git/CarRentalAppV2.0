...
func (w *ServerInterfaceWrapper) GetCar(ctx echo.Context) error {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "vin", ctx.Param("vin"), &vin, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
