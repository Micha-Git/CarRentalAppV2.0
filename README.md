...
CarRentalApp is a microservice-based application which enables to rent a car from a rental company. CarRentalAppV2.0 extends CarRentalAppV1.1 by an application microservice AM-FleetManagement by which the cars to be rented are organized in fleets.
...
[API Specification DM-CarV2.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2/dm-carv2.0/-/blob/main/src/api/specification/openapi.yaml)

[API Diagram AM-RentalManagementV2.0](./pages/ad_am-rental_management_v2.0.md)  
[API Specification AM-RentalManagementV2.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/am-rentalmanagementv2.0/-/blob/main/src/api/specification/api_specification_am_rental_management.proto)  

[API Diagram AM-FleetManagementV1.0](./pages/ad_am-fleet_management_v1.0.md)  
[API Specification AM-FleetManagementV1.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/am-fleetmanagementv1.0/-/blob/main/src/api/specification/api_specification_am_fleet_management.proto?ref_type=heads)  
...
[Microservice Implementation DM-CarV2.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/dm-carv2.0)

[Microservice Implementation AM-RentalManagementV2.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/am-rentalmanagementv2.0) 

[Microservice Implementation AM-FleetManagementV1.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/am-fleetmanagementv1.0)

[User Interface UI-CarRentalV2.0](https://gitlab.kit.edu/kit/cm/teaching/carrentalapp/carrentalappv2.0/ui-carrentalv2.0)
